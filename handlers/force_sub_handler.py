    ...
    try:
        ...
        if user.status == "kicked":
            await bot.send_message(
                ...
                text="Sorry Sir, You are Banned to use me. Contact my [𝙎𝙪𝙥𝙥𝙤𝙧𝙩 𝙂𝙧𝙤𝙪𝙥](https://t.me/Mrxofficalx).",
        ...
        await bot.send_message(
              chat_id=cmd.from_user.id,
              text="Something went Wrong. Contact my [𝙎𝙪𝙥𝙥𝙤𝙧𝙩 𝙂𝙧𝙤𝙪𝙥](https://t.me/Mrxofficalx).",
